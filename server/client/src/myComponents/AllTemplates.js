...
const all = {
    ...
    Pricing4, Services4, Subscribe4, Services3, Latestnews3, Ourprograms3, About3, Accrediation3, Footer3, Guard3, Construction,ConstHero,Corporatehero,Corporate,Industrialhero,
    Industrial, Retailhero, Retail, LogisticBanner, LogisticSector, Propertyhero, Property, Staticsecuritybanner,StaticsecurityDescription,Mobilepatrollingbanner,Mobilemonetoringdescription,
    Cctvmonetoringdescription,Lockandunlockbanner,Lockandunlockdescription,Vacantunitcheckbanner,Vacantunitdescription,Technologyproductbanner,Technologyproductdecription,Mannedguardingbanner,
