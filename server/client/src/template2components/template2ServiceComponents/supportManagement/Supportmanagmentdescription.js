...
import SupportdescriptionCss from './SupportManagmentdescription.module.css'
// import Img1 from '../../../assets/template2images/support.jpg'
import { Editor } from '@tinymce/tinymce-react';
export default function Supportmanagmentdescription({displayDevice}) {

    const editorRef = useRef(null);
    return (
        <>
        <section className={SupportdescriptionCss['service-content']}>
          <div className={displayDevice ? SupportdescriptionCss['service-container'] : SupportdescriptionCss['service-containerM']}>
            <div className={displayDevice ? SupportdescriptionCss['serv-head'] : SupportdescriptionCss['serv-headM']}>
              <h1>
                <Editor
            ...
            <div className={displayDevice ? SupportdescriptionCss['service-grid'] : SupportdescriptionCss['service-gridM']}>
              <div className={SupportdescriptionCss.sg1}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security3'
              ...
              <div className={SupportdescriptionCss.sg2}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity4'
              ...
              <div className={SupportdescriptionCss.sg3}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security5'
              ...
              <div className={SupportdescriptionCss.sg4}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity6'
              ...
              <div className={SupportdescriptionCss.sg5}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity7'
              ...
              <div className={SupportdescriptionCss.sg6}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security7'
        ...
        <section>
          <div className={displayDevice ? `${SupportdescriptionCss['icon-content']} ${SupportdescriptionCss.container365}` : `${SupportdescriptionCss['icon-contentM']} ${SupportdescriptionCss.container365M}`}>
            <div className={SupportdescriptionCss['iconized']}>
