...
export default function Supportmanagmentdescription() {

    const editorRef = useRef(null);
    return (
        <>
        <section class={['service-content']}>
            <div class={SupportdescriptionCss['service-container']}>
                <div class={SupportdescriptionCss['serv-head']}>
                    <h1>
                        <Editor
                ...
                <div class={SupportdescriptionCss['service-grid']}>
                    <div class={SupportdescriptionCss.sg1}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Event Security3'
                    ...
                    <div class={SupportdescriptionCss.sg2}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='EventSecurity4'
                    ...
                    <div class={SupportdescriptionCss.sg3}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Event Security5'
                    ...
                    <div class={SupportdescriptionCss.sg4}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='EventSecurity6'
                    ...
                    <div class={SupportdescriptionCss.sg5}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='EventSecurity7'
                    ...
                    <div class={SupportdescriptionCss.sg6}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Event Security7'
        ...
        <section>
        <div className={`${SupportdescriptionCss['icon-content']} ${SupportdescriptionCss['container365']}`}>
