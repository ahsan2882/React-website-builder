...
export default function Mannedguardingdescription({displayDevice}) {
    const editorRef = useRef(null);
    return (
        <>
            <section className={MannedguardingdescriptionCss['service-content']}>
                <div className={displayDevice ? MannedguardingdescriptionCss['service-container'] : MannedguardingdescriptionCss['service-containerM']}>
                    <div className={displayDevice ? MannedguardingdescriptionCss['serv-head'] : MannedguardingdescriptionCss['serv-headM']}>
                        <h1>
                            <Editor
                    ...
                    <div className={displayDevice ? MannedguardingdescriptionCss['service-grid'] : MannedguardingdescriptionCss['service-gridM']}>
                        <div className={MannedguardingdescriptionCss.sg1}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='Event Security3'
                        ...
                        <div className={MannedguardingdescriptionCss.sg2}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='EventSecurity4'
                        ...
                        <div className={MannedguardingdescriptionCss.sg3}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='Event Security5'
                    ...
                    culpa ad distinctio magni delectus.</p>"
                        ...
                        <div className={MannedguardingdescriptionCss.sg4}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='EventSecurity6'
                        ...
                        <div className={MannedguardingdescriptionCss.sg5}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='EventSecurity7'
                        ...
                        <div className={MannedguardingdescriptionCss.sg6}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='Event Security7'
            ...
            <section>
                <div className={displayDevice ? `${MannedguardingdescriptionCss['icon-content']} ${MannedguardingdescriptionCss.container365}` : `${MannedguardingdescriptionCss['icon-contentM']} ${MannedguardingdescriptionCss.container365M}`}>
