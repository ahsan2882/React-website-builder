...
export default function Lockandunlockdescription({displayDevice}) {
  const editorRef = useRef(null);
  return (
    <>
      <section className={LockandunlockCss['service-content']}>
        <div className={displayDevice ? LockandunlockCss['service-container'] : LockandunlockCss['service-containerM']}>
          <div className={displayDevice ? LockandunlockCss['serv-head'] : LockandunlockCss['serv-headM']}>
            <h1>
              <Editor
          ...
          <div className={displayDevice ? LockandunlockCss['service-grid'] : LockandunlockCss['service-gridM']}>
            <div className={LockandunlockCss.sg1}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security3'
            ...
            <div className={LockandunlockCss.sg2}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity4'
            ...
            <div className={LockandunlockCss.sg3}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security5'
            ...
            <div className={LockandunlockCss.sg4}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity6'
            ...
            <div className={LockandunlockCss.sg5}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity7'
            ...
            <div className={LockandunlockCss.sg6}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security7'
      ...
      <section>
        <div className={displayDevice ? `${LockandunlockCss['icon-content']} ${LockandunlockCss.container365}` : `${LockandunlockCss['icon-contentM']} ${LockandunlockCss.container365M}`}>
