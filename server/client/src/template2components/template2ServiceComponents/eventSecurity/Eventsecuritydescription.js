...
import EventdescriptionCss from './Eventsecuritydescription.module.css'
// import Img1 from '../../../assets/template2images/support.jpg'
import { Editor } from '@tinymce/tinymce-react';
export default function Eventsecuritydescription({displayDevice}) {
  const editorRef = useRef(null);
  return (
    <>
      <section className={EventdescriptionCss['service-content']}>
        <div className={displayDevice ? EventdescriptionCss['service-container'] : EventdescriptionCss['service-containerM']}>
          <div className={displayDevice ? EventdescriptionCss['serv-head'] : EventdescriptionCss['serv-headM']}>
            <h1>
              <Editor
          ...
          <div className={displayDevice ? EventdescriptionCss['service-grid'] : EventdescriptionCss['service-gridM']}>
            <div className={EventdescriptionCss.sg1}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security3'
            ...
            <div className={EventdescriptionCss.sg2}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity4'
            ...
            <div className={EventdescriptionCss.sg3}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security5'
            ...
            <div className={EventdescriptionCss.sg4}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity6'
            ...
            <div className={EventdescriptionCss.sg5}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity7'
            ...
            <div className={EventdescriptionCss.sg6}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security7'
      ...
      <section>
        <div className={displayDevice ? `${EventdescriptionCss['icon-content']} ${EventdescriptionCss.container365}` : `${EventdescriptionCss['icon-contentM']} ${EventdescriptionCss.container365M}`}>
          <div className={EventdescriptionCss['iconized']}>
