...
export default function Eventsecuritydescription() {
  const editorRef = useRef(null);
  return (
    <>
    <section class={EventdescriptionCss['service-content']} >
      <div class={EventdescriptionCss['service-container']}>
        <div class={EventdescriptionCss['serv-head']}>
          <h1>
            <Editor
        ...
        <div class={EventdescriptionCss['service-grid']}>
          <div class={EventdescriptionCss.sg1}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='Event Security3'
          ...
          <div class={EventdescriptionCss.sg2}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='EventSecurity4'
          ...
          <div class={EventdescriptionCss.sg3}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='Event Security5'
          ...
          <div class={EventdescriptionCss.sg4}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='EventSecurity6'
          ...
          <div class={EventdescriptionCss.sg5}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='EventSecurity7'
          ...
          <div class={EventdescriptionCss.sg6}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='Event Security7'
    ...
    <section>
        <div className={`${EventdescriptionCss['icon-content']} ${EventdescriptionCss['container365']}`}>
