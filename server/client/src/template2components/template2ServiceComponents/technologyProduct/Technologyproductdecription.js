...
export default function Technologyproductdecription({displayDevice}) {
    const editorRef = useRef(null);
    return (
        <>
        <section className={TechnologyproductdescriptionCss['service-content']}>
          <div className={displayDevice ? TechnologyproductdescriptionCss['service-container'] : TechnologyproductdescriptionCss['service-containerM']}>
            <div className={displayDevice ? TechnologyproductdescriptionCss['serv-head'] : TechnologyproductdescriptionCss['serv-headM']}>
              <h1>
                <Editor
            ...
            <div className={displayDevice ? TechnologyproductdescriptionCss['service-grid'] : TechnologyproductdescriptionCss['service-gridM']}>
              <div className={TechnologyproductdescriptionCss.sg1}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security3'
              ...
              <div className={TechnologyproductdescriptionCss.sg2}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity4'
              ...
              <div className={TechnologyproductdescriptionCss.sg3}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security5'
              ...
              <div className={TechnologyproductdescriptionCss.sg4}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity6'
              ...
              <div className={TechnologyproductdescriptionCss.sg5}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity7'
              ...
              <div className={TechnologyproductdescriptionCss.sg6}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security7'
        ...
        <section>
          <div className={displayDevice ? `${TechnologyproductdescriptionCss['icon-content']} ${TechnologyproductdescriptionCss.container365}` : `${TechnologyproductdescriptionCss['icon-contentM']} ${TechnologyproductdescriptionCss.container365M}`}>
            <div className={TechnologyproductdescriptionCss['iconized']}>
