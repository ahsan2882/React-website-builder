...
export default function Vacantunitdescription({displayDevice}) {
    const editorRef = useRef(null);
    return (
        <>
        <section className={VacantunitdescriptionCss['service-content']}>
          <div className={displayDevice ? VacantunitdescriptionCss['service-container'] : VacantunitdescriptionCss['service-containerM']}>
            <div className={displayDevice ? VacantunitdescriptionCss['serv-head'] : VacantunitdescriptionCss['serv-headM']}>
              <h1>
                <Editor
            ...
            <div className={displayDevice ? VacantunitdescriptionCss['service-grid'] : VacantunitdescriptionCss['service-gridM']}>
              <div className={VacantunitdescriptionCss.sg1}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security3'
              ...
              <div className={VacantunitdescriptionCss.sg2}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity4'
              ...
              <div className={VacantunitdescriptionCss.sg3}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security5'
              ...
              <div className={VacantunitdescriptionCss.sg4}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity6'
              ...
              <div className={VacantunitdescriptionCss.sg5}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity7'
              ...
              <div className={VacantunitdescriptionCss.sg6}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security7'
        ...
        <section>
          <div className={displayDevice ? `${VacantunitdescriptionCss['icon-content']} ${VacantunitdescriptionCss.container365}` : `${VacantunitdescriptionCss['icon-contentM']} ${VacantunitdescriptionCss.container365M}`}>
