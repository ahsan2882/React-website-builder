...
export default function Vacantunitdescription() {
    ...
    return (
        <>
            <section class={VacantunitdescriptionCss['service-content']}>
                <div class={VacantunitdescriptionCss['service-container']}>
                    ...
                    <div class={VacantunitdescriptionCss['service-grid']}>
                        <div class={VacantunitdescriptionCss.sg1}>
                        ...
                        <div class={VacantunitdescriptionCss.sg3}>
                        ...
                        <div class={VacantunitdescriptionCss.sg4}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='Guard1'
                        ...
                        <div class={VacantunitdescriptionCss.sg5}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='Guard1'
                        ...
                        <div class={VacantunitdescriptionCss.sg6}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='Guard1'
            ...
            <section>
        <div className={`${VacantunitdescriptionCss['icon-content']} ${VacantunitdescriptionCss['container365']}`}>
