...
export default function Guardhousedescription() {
  const editorRef = useRef(null);
  return (
    <>
    <section class={GuardhousedescriptionCss['service-content']} >
      <div class={GuardhousedescriptionCss['service-container']}>
        <div class={GuardhousedescriptionCss['serv-head']}>
          <h1>
            <Editor
        ...
        <div class={GuardhousedescriptionCss['service-grid']}>
          <div class={GuardhousedescriptionCss.sg1}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='Event Security3'
          ...
          <div class={GuardhousedescriptionCss.sg2}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='EventSecurity4'
          ...
          <div class={GuardhousedescriptionCss.sg3}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='Event Security5'
          ...
          <div class={GuardhousedescriptionCss.sg4}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='EventSecurity6'
          ...
          <div class={GuardhousedescriptionCss.sg5}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='EventSecurity7'
          ...
          <div class={GuardhousedescriptionCss.sg6}>
            <Editor
              onInit={(evt, editor) => editorRef.current = editor}
              inline={true}
              key='Event Security7'
    ...
    <section>
        <div className={`${GuardhousedescriptionCss['icon-content']} ${GuardhousedescriptionCss['container365']}`}>
