...
import GuardhousedescriptionCss from './Guardhousedescription.module.css'
// import Img1 from '../../../assets/template2images/support.jpg'
import { Editor } from '@tinymce/tinymce-react';
export default function Guardhousedescription({displayDevice}) {
  const editorRef = useRef(null);
  return (
    <>
      <section className={GuardhousedescriptionCss['service-content']}>
        <div className={displayDevice ? GuardhousedescriptionCss['service-container'] : GuardhousedescriptionCss['service-containerM']}>
          <div className={displayDevice ? GuardhousedescriptionCss['serv-head'] : GuardhousedescriptionCss['serv-headM']}>
            <h1>
              <Editor
          ...
          <div className={displayDevice ? GuardhousedescriptionCss['service-grid'] : GuardhousedescriptionCss['service-gridM']}>
            <div className={GuardhousedescriptionCss.sg1}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security3'
            ...
            <div className={GuardhousedescriptionCss.sg2}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity4'
            ...
            <div className={GuardhousedescriptionCss.sg3}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security5'
            ...
            <div className={GuardhousedescriptionCss.sg4}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity6'
            ...
            <div className={GuardhousedescriptionCss.sg5}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity7'
            ...
            <div className={GuardhousedescriptionCss.sg6}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security7'
      ...
      <section>
        <div className={displayDevice ? `${GuardhousedescriptionCss['icon-content']} ${GuardhousedescriptionCss.container365}` : `${GuardhousedescriptionCss['icon-contentM']} ${GuardhousedescriptionCss.container365M}`}>
          <div className={GuardhousedescriptionCss['iconized']}>
