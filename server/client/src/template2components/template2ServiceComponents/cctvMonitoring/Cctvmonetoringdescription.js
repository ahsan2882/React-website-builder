...
export default function Cctvmonetoringdescription({displayDevice}) {
  const editorRef = useRef(null);
  return (
    <>
    
      <section className={CctvdescriptionCss['service-content']}>
        <div className={displayDevice ? CctvdescriptionCss['service-container'] : CctvdescriptionCss['service-containerM']}>
          <div className={displayDevice ? CctvdescriptionCss['serv-head'] : CctvdescriptionCss['serv-headM']}>
            <h1>
              <Editor
          ...
          <div className={displayDevice ? CctvdescriptionCss['service-grid'] : CctvdescriptionCss['service-gridM']}>
            <div className={CctvdescriptionCss.sg1}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security3'
            ...
            <div className={CctvdescriptionCss.sg2}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity4'
            ...
            <div className={CctvdescriptionCss.sg3}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security5'
            ...
            <div className={CctvdescriptionCss.sg4}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity6'
            ...
            <div className={CctvdescriptionCss.sg5}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='EventSecurity7'
            ...
            <div className={CctvdescriptionCss.sg6}>
              <Editor
                onInit={(evt, editor) => editorRef.current = editor}
                inline={true}
                key='Event Security7'
      ...
      <section>
        <div className={displayDevice ? `${CctvdescriptionCss['icon-content']} ${CctvdescriptionCss.container365}` : `${CctvdescriptionCss['icon-contentM']} ${CctvdescriptionCss.container365M}`}>
          <div className={CctvdescriptionCss['iconized']}>
