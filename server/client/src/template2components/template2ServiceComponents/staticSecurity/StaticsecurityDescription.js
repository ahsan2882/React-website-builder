...
export default function StaticsecurityDescription({displayDevice}) {
    const editorRef = useRef(null);
    return (
        <>
        <section className={StaticsecurityCss['service-content']}>
          <div className={displayDevice ? StaticsecurityCss['service-container'] : StaticsecurityCss['service-containerM']}>
            <div className={displayDevice ? StaticsecurityCss['serv-head'] : StaticsecurityCss['serv-headM']}>
              <h1>
                <Editor
            ...
            <div className={displayDevice ? StaticsecurityCss['service-grid'] : StaticsecurityCss['service-gridM']}>
              <div className={StaticsecurityCss.sg1}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security3'
              ...
              <div className={StaticsecurityCss.sg2}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity4'
              ...
              <div className={StaticsecurityCss.sg3}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security5'
              ...
              <div className={StaticsecurityCss.sg4}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity6'
              ...
              <div className={StaticsecurityCss.sg5}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity7'
              ...
              <div className={StaticsecurityCss.sg6}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security7'
        ...
        <section>
          <div className={displayDevice ? `${StaticsecurityCss['icon-content']} ${StaticsecurityCss.container365}` : `${StaticsecurityCss['icon-contentM']} ${StaticsecurityCss.container365M}`}>
