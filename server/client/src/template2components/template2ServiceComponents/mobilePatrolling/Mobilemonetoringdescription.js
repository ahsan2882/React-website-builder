...
export default function Mobilemonetoringdescription() {
    const editorRef = useRef(null);
    return (
        <>
        <section class={['service-content']}>
            <div class={MobilemonetoringdescriptionCss['service-container']}>
                <div class={MobilemonetoringdescriptionCss['serv-head']}>
                    <h1>
                        <Editor
                ...
                <div class={MobilemonetoringdescriptionCss['service-grid']}>
                    <div class={MobilemonetoringdescriptionCss.sg1}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Event Security3'
                    ...
                    <div class={MobilemonetoringdescriptionCss.sg2}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='EventSecurity4'
                    ...
                    <div class={MobilemonetoringdescriptionCss.sg3}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Event Security5'
                    ...
                    <div class={MobilemonetoringdescriptionCss.sg4}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='EventSecurity6'
                    ...
                    <div class={MobilemonetoringdescriptionCss.sg5}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='EventSecurity7'
                    ...
                    <div class={MobilemonetoringdescriptionCss.sg6}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Event Security7'
        ...
        <section>
        <div className={`${MobilemonetoringdescriptionCss['icon-content']} ${MobilemonetoringdescriptionCss['container365']}`}>
