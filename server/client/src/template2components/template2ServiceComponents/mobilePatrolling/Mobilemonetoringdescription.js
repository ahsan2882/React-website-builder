...
import MobilemonetoringdescriptionCss from './Mobilemonetoringdescription.module.css'
// import Img1 from '../../../assets/template2images/support.jpg'
import { Editor } from '@tinymce/tinymce-react';
export default function Mobilemonetoringdescription({displayDevice}) {
    const editorRef = useRef(null);
    return (
        <>
        <section className={MobilemonetoringdescriptionCss['service-content']}>
          <div className={displayDevice ? MobilemonetoringdescriptionCss['service-container'] : MobilemonetoringdescriptionCss['service-containerM']}>
            <div className={displayDevice ? MobilemonetoringdescriptionCss['serv-head'] : MobilemonetoringdescriptionCss['serv-headM']}>
              <h1>
                <Editor
            ...
            <div className={displayDevice ? MobilemonetoringdescriptionCss['service-grid'] : MobilemonetoringdescriptionCss['service-gridM']}>
              <div className={MobilemonetoringdescriptionCss.sg1}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security3'
              ...
              <div className={MobilemonetoringdescriptionCss.sg2}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity4'
              ...
              <div className={MobilemonetoringdescriptionCss.sg3}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security5'
              ...
              <div className={MobilemonetoringdescriptionCss.sg4}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity6'
              ...
              <div className={MobilemonetoringdescriptionCss.sg5}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='EventSecurity7'
              ...
              <div className={MobilemonetoringdescriptionCss.sg6}>
                <Editor
                  onInit={(evt, editor) => editorRef.current = editor}
                  inline={true}
                  key='Event Security7'
        ...
        <section>
          <div className={displayDevice ? `${MobilemonetoringdescriptionCss['icon-content']} ${MobilemonetoringdescriptionCss.container365}` : `${MobilemonetoringdescriptionCss['icon-contentM']} ${MobilemonetoringdescriptionCss.container365M}`}>
            <div className={MobilemonetoringdescriptionCss['iconized']}>
