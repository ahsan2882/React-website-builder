...
import AboutheroCss from './Abouthero.module.css'
export default function Abouthero() {
    const editorRef = useRef(null);
    return (
<>
<section className={`relative ${AboutheroCss.hero}`}>
<Editor
                        ...
                        />
                        <div className={`absolute top-1/2 left-36 text-white ${AboutheroCss.head}`}>
