...
export default function Service3Asset({displayDevice}) {
            ...
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-col">
                        ...
                        <div className={displayDevice ? "flex flex-wrap sm:flex-row flex-col py-6 mb-12":"flex flex-wrap  flex-col py-6 mb-12"}>
                            <h1 className={displayDevice ?"sm:w-2/5 text-gray-900 font-medium title-font text-2xl mb-2 sm:mb-0":"text-gray-900 font-medium title-font text-2xl mb-2"}>
                                <Editor
                            ...
                            <p className={displayDevice ? "sm:w-3/5 leading-relaxed text-base sm:pl-10 pl-0": "leading-relaxed text-base  pl-0"}>
                                <Editor
                                    onInit={(evt, editor) => (editorRef.current = editor)}
                                    inline={true}
                                    key="service3asset2"
                    ...
                    <div className={displayDevice ?"flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4":"flex flex-wrap -mx-4 -mb-10 -mt-4"}>
                        <div className={displayDevice ? "p-4 md:w-1/3 sm:mb-0 mb-6":"p-4 mb-6"}>
