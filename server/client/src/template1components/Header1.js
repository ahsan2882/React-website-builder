...
export const Header1 = ({ showPopup, overSection, displayDevice, linksfunc, setNav1Services, nav1Service, templateComponents, setTempComp}) => {
  ...
  return (
    <>
      <Navbar1 setTempComp={setTempComp} displayDevice={displayDevice} linksfunc={linksfunc} setNav1Services={setNav1Services} nav1Service={nav1Service} templateComponents={templateComponents} />
