...
export default function Mobilepatrolling3({ showPopup, overSection, displayDevice, linksfunc, setNav1Services, nav1Service , setTempComp , templateComponents }) {
    const editorRef = useRef(null);
    return (
        <>
            <Navbar1 displayDevice={displayDevice} linksfunc={linksfunc} setNav1Services={setNav1Services} setTempComp={setTempComp} nav1Service={nav1Service} templateComponents={templateComponents}/>
