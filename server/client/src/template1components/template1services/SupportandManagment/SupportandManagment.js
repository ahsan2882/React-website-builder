...
import SupportCss from './Supportmanagment.module.css'
// import Img1 from '../../../assets/template1images/wavef1.png'
// import Img2 from '../../../assets/template1images/services66.jpg'
import { Editor } from '@tinymce/tinymce-react';
import Navbar1 from '../../Navbar1';
export default function SupportandManagment({ showPopup, overSection, displayDevice, linksfunc , setTempComp , setNav1Services, nav1Service , templateComponents}) {
        ...
        <><Navbar1 displayDevice={displayDevice} linksfunc={linksfunc} setTempComp={setTempComp} setNav1Services={setNav1Services} nav1Service={nav1Service} templateComponents={templateComponents}/>
            <section className={displayDevice ? `${SupportCss['services-sec']} overflow-hidden` : `${SupportCss['services-secM']} overflow-hidden`}>
                ...
                <div className={displayDevice ? `${SupportCss['containers']} ${SupportCss['grid-contact']}` : `${SupportCss['containers']} ${SupportCss['grid-contactM']}`}>
                    <div className={displayDevice ? `${SupportCss['services-text']}` : `${SupportCss['services-textM']}`}>
                        ...
                        <h1>
                            <Editor
                                ...
                                inline={true}
                                key='Static1'
                                initialValue="Support And Management"
                                init={{
                                    plugins: [
                                        "link"
                                    ],
                        ...
                        <button style={{ "margin-bottom": "40px;" }} className={SupportCss.btna}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='Static10'
                    ...
                    <div className={displayDevice ? `${SupportCss['services-image']}` : `${SupportCss['services-imageM']}`}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Static2'
            ...
            <div className={displayDevice ? SupportCss['wave-services'] : SupportCss['wave-servicesM']}>
                <img src="https://i.ibb.co/NL83nFf/wavef1.png" alt="wavef1" />
            </div>
            <section className={`${SupportCss['sec-serv']} ${SupportCss['desc-services']}`}>
                <div className={SupportCss.container}>
                    <div className={SupportCss['services-text2']}>
                        <div className={SupportCss['txt-serv']}>
                    ...
                    <div className={displayDevice ? `${SupportCss['container-sv']} ${SupportCss['grid-r3']}` : `${SupportCss['container-svM']} ${SupportCss['grid-r3M']}`}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Static4'
