...
import TechnoCss from './Technologyproduct.module.css'
// import Img1 from '../../../assets/template1images/wavef1.png'
// import Img2 from '../../../assets/template1images/services56.jpg'
import { Editor } from '@tinymce/tinymce-react';
import Navbar1 from '../../Navbar1';
export default function Technologyproduct3({ showPopup, overSection, displayDevice, setTempComp, linksfunc, setNav1Services, nav1Service, templateComponents }) {
    const editorRef = useRef(null);
    return (
        <><Navbar1 displayDevice={displayDevice} linksfunc={linksfunc} setTempComp={setTempComp} setNav1Services={setNav1Services} nav1Service={nav1Service} templateComponents={templateComponents} />
            <section className={displayDevice ? `${TechnoCss['services-sec']} overflow-hidden` : `${TechnoCss['services-secM']} overflow-hidden`}>
                ...
                <div className={displayDevice ? `${TechnoCss['containers']} ${TechnoCss['grid-contact']}` : `${TechnoCss['containers']} ${TechnoCss['grid-contactM']}`}>
                    <div className={displayDevice ? `${TechnoCss['services-text']}` : `${TechnoCss['services-textM']}`}>
                        ...
                        <button style={{ "margin-bottom": "40px;" }} className={TechnoCss.btna}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='Static10'
                    ...
                    <div className={displayDevice ? `${TechnoCss['services-image']}` : `${TechnoCss['services-imageM']}`}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Static2'
                            initialValue={`<img src="https://i.ibb.co/47P9jLk/services56.jpg" alt="services56" class="object-cover"/>`}
                            init={{
                                forced_root_block: "",
                                menubar: false,
            ...
            <div className={displayDevice ? TechnoCss['wave-services'] : TechnoCss['wave-servicesM']}>
                <img src="https://i.ibb.co/NL83nFf/wavef1.png" alt="wavef1" />
            </div>
            <section className={`${TechnoCss['sec-serv']} ${TechnoCss['desc-services']}`}>
                <div className={TechnoCss.container}>
                    <div className={TechnoCss['services-text2']}>
                        <div className={TechnoCss['txt-serv']}>
                    ...
                    <div className={displayDevice ? `${TechnoCss['container-sv']} ${TechnoCss['grid-r3']}` : `${TechnoCss['container-svM']} ${TechnoCss['grid-r3M']}`}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Static4'
