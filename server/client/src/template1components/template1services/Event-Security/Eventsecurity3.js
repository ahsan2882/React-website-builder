...
import Eventsecurity3Css from './Eventsecurity.module.css'
// import Img1 from '../../../assets/template1images/wavef1.png'
// import Img2 from '../../../assets/template1images/servicesbg.jpg'
import { Editor } from '@tinymce/tinymce-react';
import Navbar1 from '../../Navbar1';
export default function Eventsecurity3({ showPopup, overSection, displayDevice, linksfunc , setNav1Services, nav1Service , templateComponents , setTempComp}) {
            ...
            <section className={displayDevice ? `${Eventsecurity3Css['services-sec']} overflow-hidden` : `${Eventsecurity3Css['services-secM']} overflow-hidden`}>
                ...
                <div className={displayDevice ? `${Eventsecurity3Css['containers']} ${Eventsecurity3Css['grid-contact']}` : `${Eventsecurity3Css['containers']} ${Eventsecurity3Css['grid-contactM']}`}>
                    <div className={displayDevice ? `${Eventsecurity3Css['services-text']}` : `${Eventsecurity3Css['services-textM']}`}>
                        ...
                        <button style={{ "margin-bottom": "40px;" }} className={Eventsecurity3Css.btna}>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='Static10'
