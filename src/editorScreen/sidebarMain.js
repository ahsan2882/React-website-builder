...
export const sidebarAssets = [
    ...
    },
    {
        ...
        assets: [
            ...
            { imageName: testimonialAss3, id: "testimonial3" },
            { imageName: testimonialAss4, id: "testimonial4" }
        ]
    },
    {
        assetName: 'FAQs',
        assets: [
            ...
            { imageName: faqsAss3, id: "faqs3" },
            { imageName: faqsAss4, id: "faqs4" }
        ]
    },
    {
        assetName: 'contact',
    ...
    },
    {
        ...
        assets: [
            { imageName: socialAss1, id: "social1" },
            { imageName: socialAss2, id: "social2" },
    ...
    // },
    {
        assetName: 'pricing',
        assets: [
            { imageName: pricingAss1, id: "pricing1" },
            { imageName: pricingAss2, id: "pricing2" },
            { imageName: pricingAss3, id: "pricing3" },
            { imageName: pricingAss4, id: "pricing4" },
            { imageName: pricingAss5, id: "pricing5" }
        ]
    },
    {
        assetName: 'services',
        assets: [
            { imageName: serviceAss1, id: "service1" },
            { imageName: serviceAss2, id: "service2" },
            { imageName: serviceAss3, id: "service3" },
            { imageName: serviceAss4, id: "service4" },
            { imageName: serviceAss5, id: "service5" }
        ]
    },
    {
