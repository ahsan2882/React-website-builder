    ...
    return (
        <>
            <div className="flex flex-col justify-center items-center h-full">
                ...
                <i className="fas fa-times transform rotate-45 rounded-full px-4 py-3 justify-center items-center flex bg-blue-700 text-white text-2xl"></i>
            </button></div> */}
