                                ...
                                return (
                                    <>
                                        <section key={index}
                                            ...
                                            <div className="flex w-52 justify-evenly items-center toBeRemoved" style={(overSection && sectionKey === index) ? { position: "absolute", top: "5rem", right: "4rem", zIndex: "9999999" } : { display: "none" }}>
