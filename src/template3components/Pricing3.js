...
import Pricing3Css from './Pricing3.module.css'
export default function Pricing3() {
    const editorRef = useRef(null);
    return (
        <>
            <section className={Pricing3Css['pricing-sec']}>
                <div className={Pricing3Css['container-pricing']}>
                    <div className={Pricing3Css['price-card-wrapper']}>
                        <div className={Pricing3Css['price-card-c']}>
                            <h1>
                                <Editor
                            ...
                            <div className={Pricing3Css['price-content-c']}>
                                <h2>
                                    <Editor
                                        onInit={(evt, editor) => (editorRef.current = editor)}
                                        inline={true}
                            ...
                            <button className={Pricing3Css['button-sqr']}>
                                <Editor
                                    onInit={(evt, editor) => (editorRef.current = editor)}
                                    inline={true}
                                    key="pricing3asset3"
                        ...
                        <div className={Pricing3Css['price-card']}>
                            <h1>
                                <Editor
                                    onInit={(evt, editor) => (editorRef.current = editor)}
                                    inline={true}
                            ...
                            <div className={Pricing3Css['price-content']}>
                                <h2>
                                    <Editor
                                        onInit={(evt, editor) => (editorRef.current = editor)}
                                        inline={true}
                            ...
                            <button className={Pricing3Css['button-sqr']}>Get Quote </button >
