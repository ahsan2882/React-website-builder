...
import StaticSecurity3Css from './Vacantunitcheck.module.css'
        ...
        <><Navbar1 displayDevice={displayDevice} linksfunc={linksfunc} />
            <section className={StaticSecurity3Css['services-sec']}>
                ...
                the interests of our clients.</p>"
                        ...
                        {/* <img src="https://i.ibb.co/WHMMz8H/service55.jpg" alt="service55" border="0"> */}
                    </div>
                    <div className={`${StaticSecurity3Css['slide-in']} ${StaticSecurity3Css['services-text']}`}>
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='Static2'
                            initialValue={`<img src="https://i.ibb.co/WHMMz8H/service55.jpg" alt="service55" class="w-96 h-72 object-cover"/>`}
                            init={{
                                forced_root_block: "",
                                menubar: false,
            ...
            <div className={StaticSecurity3Css['wave-services']}>
                {/* <img src="https://i.ibb.co/NL83nFf/wavef1.png" alt="wavef1" border="0"> */}
                ...
                <div className={StaticSecurity3Css.container}>
                    <div className={StaticSecurity3Css['services-text2']}>
                        ...
                        <Editor
                                    ...
                                    inline={true}
                                    key='Static3'
                                    initialValue={`<span class="${StaticSecurity3Css.line1}"> Vecant </span><span class="${StaticSecurity3Css.line2}"> Unit Check</span>`}
                                    init={{
                                        plugins: [
                                            "link"
                                        ],
