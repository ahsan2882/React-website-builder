...
import StaticSecurity3Css from './Technologyproduct.module.css'
        ...
        <section className={StaticSecurity3Css['services-sec']}>
            ...
            <div className={`${StaticSecurity3Css['containers']} ${StaticSecurity3Css['grid-contact']}`}>
                <div className={`${StaticSecurity3Css['slide-in']} ${StaticSecurity3Css['services-text']}`}>
                    ...
                    <div className={`${StaticSecurity3Css['slide-in']} ${StaticSecurity3Css['services-text']}`}>
                        {/* <img src="https://i.ibb.co/47P9jLk/services56.jpg" alt="services56" border="0"> */}
                    <Editor
                        onInit={(evt, editor) => editorRef.current = editor}
                        inline={true}
                        key='Static2'
                            initialValue={`<img src="https://i.ibb.co/47P9jLk/services56.jpg" alt="services56" class="w-96 h-72 object-cover"/>`}
                        init={{
                            forced_root_block: "",
                            menubar: false,
                ...
                <div className={StaticSecurity3Css['services-text2']}>
                    <div className={StaticSecurity3Css['txt-serv']}>
                        ...
                        <Editor
                                    ...
                                    inline={true}
                                    key='Static3'
                                    initialValue={`<span class="${StaticSecurity3Css.line1}"> Technology </span><span class="${StaticSecurity3Css.line2}"> Product</span>`}
                                    init={{
                                        plugins: [
                                            "link"
                                        ],
