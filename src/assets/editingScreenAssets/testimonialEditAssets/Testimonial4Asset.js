                            ...
                            <div class="flex flex-wrap justify-around">
                                    ...
                                    <div class="shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded">
                                        ...
                                        <div class="pl-6 pr-6 pt-10 relative h-64">
                                            <div class="h-16 w-16 rounded-full bg-cover border-4 border-white absolute top-0 right-0 -mt-8 mr-6">
                                                <img src="https://cdn.tuk.dev/assets/photo-1566753323558-f4e0952af115.jfif" alt="Display Avatar of Alex Parkinson"  class="h-full w-full object-cover rounded-full overflow-hidden" />
                                            </div>
                                ...
                                <div class="xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:mb-0 mb-12">
                                    <div class="shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded">
                                        ...
                                        <div class="pl-6 pr-6 pt-10 relative h-64">
                                            <div class="h-16 w-16 rounded-full bg-cover border-4 border-white absolute top-0 right-0 -mt-8 mr-6">
                                                <img src="https://cdn.tuk.dev/assets/photo-1548958921-c5c0fe1b307d.jfif" alt="Display Avatar of Ashley Wilson"  class="h-full w-full object-cover rounded-full overflow-hidden" />
                                            </div>
                                ...
                                <div class="xl:w-1/3 lg:w-5/12 w-11/12 sm:w-3/5 md:w-5/12 xl:mb-0 mb-12">
                                    <div class="shadow-lg mx-3 xl:mx-3 sm:mx-0 lg:mx-0 rounded">
                                        ...
                                        <div class="pl-6 pr-6 pt-10 relative h-64">
                                            <div class="h-16 w-16 rounded-full bg-cover border-4 border-white absolute top-0 right-0 -mt-8 mr-6">
                                                <img src="https://cdn.tuk.dev/assets/photo-1564061170517-d3907caa96ea.jfif" alt="Display Avatar of Richard Clark"  class="h-full w-full object-cover rounded-full overflow-hidden" />
                                            </div>
