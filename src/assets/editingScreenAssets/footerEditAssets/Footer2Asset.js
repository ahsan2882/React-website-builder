            ...
            <footer className="text-gray-400 bg-gray-900 body-font">
                <div className="container px-5 py-24 mx-auto">
                    <div className="flex flex-wrap md:text-left text-center order-first">
                        <div className="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
                            ...
                            <p className="mt-2 text-sm text-gray-500">For your personal safety</p>
                        </div>
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            <h2 className="title-font font-medium text-white tracking-widest text-sm mb-3">SERVICES</h2>
                            <nav className="list-none mb-10">
                                <li>
                                    <button className="text-gray-400 hover:text-white">Mobile Petrolling</button>
                                </li>
                                <li>
                                    <button className="text-gray-400 hover:text-white">Static Security</button>
                                </li>
                                <li>
                                    <button className="text-gray-400 hover:text-white">CCTV Monitoring</button>
                                </li>
                        ...
                        <div className="lg:w-1/4 md:w-1/2 w-full px-4">
                            ...
                            <nav className="list-none mb-10">
                                ...
                                <li>
                                    <button className="text-gray-400 hover:text-white">Sectors</button>
                                </li>
                ...
                <div className="bg-gray-800 bg-opacity-75">
                    <div className="container px-5 py-6 mx-auto flex items-center sm:flex-row flex-col">
                        ...
                        <p className="text-sm text-gray-400 sm:ml-6 sm:mt-0 mt-4">© 2021 Security Guard
