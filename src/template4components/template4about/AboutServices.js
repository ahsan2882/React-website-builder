...
import AboutServicesmoduleCss from './AboutServices.module.css'
// import Serimg from './guard-for-services-sec.png'
export default function AboutServices({ showPopup, overSection }) {
    ...
    return (
        ...
        <>
            ...
            <section style={{ background: currentBackground, maxWidth: "74rem;" }} className={`${AboutServicesmoduleCss.serviceswrap}`}>
                <Editor
                    onInit={(evt, editor) => editorRef.current = editor}
                    inline={true}
                    key='abouted4'
                    tinymceScriptSrc="../assets/tinymce/tinymce.min.js"
                    initialValue={` <p>  The Best Services</p>`}
                    init={{
                        forced_root_block: "",
                        menubar: false,
                ...
                <div style={{ background: currentBackground }} className={`${AboutServicesmoduleCss.rowserv}`}>
                    <div className={`${AboutServicesmoduleCss.colser1}`}>
                        ...
                        <h2>
                            <Editor
                                ...
                                key='abouted4'
                                tinymceScriptSrc="../assets/tinymce/tinymce.min.js"
                                initialValue="01. Static Security"
                                init={{
                                    forced_root_block: "",
                                    menubar: false,
                                    toolbar: 'bold italic underline | fontsizeselect | backcolor forecolor | alignleft aligncenter ' +
                        ...
                        <Editor
                            ...
                            key='abouted4'
                            tinymceScriptSrc="../assets/tinymce/tinymce.min.js"
                            initialValue={`<p>Sed nibh sapien, auctor nec eleifend in, mattis non purus. Aliquam bibendum tempor ligula, id suscipit justo euismod quis.</p>                                        `}
                            init={{
                                forced_root_block: "",
                                menubar: false,
                                toolbar: 'bold italic underline | fontsizeselect | backcolor forecolor | alignleft aligncenter ' +
                        ...
                        <h2>
                            <Editor
                                ...
                                key='abouted4'
                                tinymceScriptSrc="../assets/tinymce/tinymce.min.js"
                                initialValue="02. Static Security"
                                init={{
                                    forced_root_block: "",
                                    menubar: false,
                                    toolbar: 'bold italic underline | fontsizeselect | backcolor forecolor | alignleft aligncenter ' +
                        ...
                        /><h2>
                            <Editor
                                ...
                                key='abouted4'
                                tinymceScriptSrc="../assets/tinymce/tinymce.min.js"
                                initialValue="03. Static Security"
                                init={{
                                    forced_root_block: "",
                                    menubar: false,
                                    toolbar: 'bold italic underline | fontsizeselect | backcolor forecolor | alignleft aligncenter ' +
                        ...
                        />    </div>
                    <div className={`${AboutServicesmoduleCss.serimg}`}>
                        {/* <img src="https://i.ibb.co/M29c24H/guard-for-services-sec.png" alt="guard-for-services-sec" border="0"> */}
                        <Editor
                            onInit={(evt, editor) => editorRef.current = editor}
                            inline={true}
                            key='abouted1'
                    ...
                    <div className={`${AboutServicesmoduleCss.colser2}`}>
                        <h2>
                            <Editor
                                onInit={(evt, editor) => editorRef.current = editor}
                                inline={true}
                                key='abouted4'
                                tinymceScriptSrc="../assets/tinymce/tinymce.min.js"
                                initialValue="04. Static Security"
                                init={{
                                    forced_root_block: "",
                                    menubar: false,
                                    toolbar: 'bold italic underline | fontsizeselect | backcolor forecolor | alignleft aligncenter ' +
                        ...
                        /><h2>
                            <Editor
                                ...
                                key='abouted4'
                                tinymceScriptSrc="../assets/tinymce/tinymce.min.js"
                                initialValue="05. Static Security"
                                init={{
                                    forced_root_block: "",
                                    menubar: false,
                                    toolbar: 'bold italic underline | fontsizeselect | backcolor forecolor | alignleft aligncenter ' +
                        ...
                        /><h2>
                            <Editor
                                ...
                                key='abouted4'
                                tinymceScriptSrc="../assets/tinymce/tinymce.min.js"
                                initialValue="06. Static Security"
                                init={{
                                    forced_root_block: "",
                                    menubar: false,
                                    toolbar: 'bold italic underline | fontsizeselect | backcolor forecolor | alignleft aligncenter ' +
