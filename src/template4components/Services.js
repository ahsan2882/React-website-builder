...
export default function Services() {
    return (
        <div className={`text-center py-28 px-0 bg-black ${Service4Css.serviceWrapper}`}>
            <h4 className={`text-center font-black ${Service4Css.serviceMainHead}`}>WHAT WE DO</h4>
            <h2 className="text-center text-5xl opacity-80 text-white font-black">Our Services</h2>
            <p className={`${Service4Css.servicsDesc} text-center text-white my-12 mx-auto leading-6 font-light`}>
