    ...
    <div class={`${CorporatemoduleCss['sector-container']}`}>
        <div class={`${CorporatemoduleCss['sector_left-content']}`}>
            ...
            <Editor
                            ...
                            initialValue="Lorem ipsum dolor sit amet dolor sit amet."
                            init={{
                                forced_root_block: "",
                                menubar: false,
            ...
            <Editor
                        ...
                        key='hero4ed2'
                        tinymceScriptSrc={process.env.PUBLIC_URL + '/tinymce/tinymce.min.js'}
                        initialValue={`<p>      Corporate sites are some of the largest targets of theft and vandalism in the country. In fact, statistics from the
                        ...
                        For someone who is responsible for a Corporate site, these numbers indicate just how critical Corporate site
                        security is to the overall safety and success of your project. No matter the size or scope of your Corporate project,
        ...
        <div class={`${CorporatemoduleCss['sector_right-cards']}`}>
            ...
            <div class={`${CorporatemoduleCss['sector-card']}`}>
            <Editor
                    onInit={(evt, editor) => editorRef.current = editor}
                    inline={true}
                    key='abouted1'
                    initialValue={`<img  src="https://i.ibb.co/c8STtRy/news3.png" alt="about" class=" w-12 h-32 object-cover"/>`}
                    init={{
                        forced_root_block: "",
                        menubar: false,
