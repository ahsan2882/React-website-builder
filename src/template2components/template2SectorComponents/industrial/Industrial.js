    ...
    <div class={`${IndustrialnmoduleCss['sector-container']}`}>
        <div class={`${IndustrialnmoduleCss['sector_left-content']}`}>
            ...
            <Editor
                            ...
                            initialValue="Industrialn Site Security: Protect Your Most Valuable Assets"
                            init={{
                                forced_root_block: "",
                                menubar: false,
            ...
            <Editor
                        ...
                        key='hero4ed2'
                        tinymceScriptSrc={process.env.PUBLIC_URL + '/tinymce/tinymce.min.js'}
                        initialValue={`<p>      Industrialn sites are some of the largest targets of theft and vandalism in the country. In fact, statistics from the
                        ...
                        For someone who is responsible for a Industrialn site, these numbers indicate just how critical Industrialn site
                        security is to the overall safety and success of your project. No matter the size or scope of your Industrialn project,
        ...
        <div class={`${IndustrialnmoduleCss['sector_right-cards']}`}>
            ...
            <div class={`${IndustrialnmoduleCss['sector-card']}`}>
            <Editor
                    onInit={(evt, editor) => editorRef.current = editor}
                    inline={true}
                    key='abouted1'
