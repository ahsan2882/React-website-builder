    ...
    <div class={`${ConstructionmoduleCss['sector-container']}`}>
        <div class={`${ConstructionmoduleCss['sector_left-content']}`}>
            ...
            <Editor
                            ...
                            initialValue="Construction Site Security: Protect Your Most Valuable Assets"
                            init={{
                                forced_root_block: "",
                                menubar: false,
            ...
            <Editor
                        ...
                        key='hero4ed2'
                        tinymceScriptSrc={process.env.PUBLIC_URL + '/tinymce/tinymce.min.js'}
                        initialValue={`<p>      Construction sites are some of the largest targets of theft and vandalism in the country. In fact, statistics from the
                        ...
                        For someone who is responsible for a construction site, these numbers indicate just how critical construction site
                        security is to the overall safety and success of your project. No matter the size or scope of your construction project,
