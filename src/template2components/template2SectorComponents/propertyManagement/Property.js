    ...
    <div class={`${PropertymoduleCss['sector-container']}`}>
        <div class={`${PropertymoduleCss['sector_left-content']}`}>
            ...
            <Editor
                            ...
                            initialValue="Property Site Security: Protect Your Most Valuable Assets"
                            init={{
                                forced_root_block: "",
                                menubar: false,
            ...
            <Editor
                        ...
                        key='hero4ed2'
                        tinymceScriptSrc={process.env.PUBLIC_URL + '/tinymce/tinymce.min.js'}
                        initialValue={`<p>      Property sites are some of the largest targets of theft and vandalism in the country. In fact, statistics from the
                        ...
                        For someone who is responsible for a Property site, these numbers indicate just how critical Property site
                        security is to the overall safety and success of your project. No matter the size or scope of your Property project,
