...
export default function ServillanceDescription() {
    ...
    return (
        ...
        <div class={ServillancedescriptionCss['service-container']}>
            <div class={ServillancedescriptionCss['serv-head']}>
                <h1>
                    <Editor
            ...
            <div class={ServillancedescriptionCss['service-grid']}>
                <div class={ServillancedescriptionCss.sg1}>
                    <Editor
                        onInit={(evt, editor) => editorRef.current = editor}
                        inline={true}
                        key='Event Security3'
                ...
                <div class={ServillancedescriptionCss.sg2}>
                    <Editor
                        onInit={(evt, editor) => editorRef.current = editor}
                        inline={true}
                        key='EventSecurity4'
                ...
                <div class={ServillancedescriptionCss.sg3}>
                    <Editor
                        onInit={(evt, editor) => editorRef.current = editor}
                        inline={true}
                        key='Event Security5'
                ...
                <div class={ServillancedescriptionCss.sg4}>
                    <Editor
                        onInit={(evt, editor) => editorRef.current = editor}
                        inline={true}
                        key='EventSecurity6'
                ...
                <div class={ServillancedescriptionCss.sg5}>
                    <Editor
                        onInit={(evt, editor) => editorRef.current = editor}
                        inline={true}
                        key='EventSecurity7'
                ...
                <div class={ServillancedescriptionCss.sg6}>
                    <Editor
                        onInit={(evt, editor) => editorRef.current = editor}
                        inline={true}
                        key='Event Security7'
